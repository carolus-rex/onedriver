...
class OneDrive(object):
    ...
    def bauthenticator(self):
        ...
        code = GetAuthCodeServer.get_auth_code(auth_url, redirect_uri)
        auth.authenticate(code, redirect_uri, self.client_secret, resource=discovery_uri)
    ...
    def download(self, remote_path, local_path):
        ...
        self.client.item(drive='me', id=id).download(
            os.path.abspath(local_path) + (remote_filename if local_filename == '' else ''))
